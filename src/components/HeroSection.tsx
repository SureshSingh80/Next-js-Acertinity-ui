      ...
      />
        <div className="p-4 relative z-10 w-full text-center">
            ...
            <p className="mt-4 font-normal text-base md:text-lg text-neutral-300 max-w-lg mx-auto">
                Dive into your comprehensive music courses and transform your musical journey today.
                Wheather you are beginner or looking to refine your skill, join us to unlock your true potential.
            </p>
